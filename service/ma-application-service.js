...
async function createNewMarketingAuthorisationApplication (payload) {
    let url = `${TEST_SUPPORT_API_URL}/MarketingAuthorisationApplication/new`
...
async function createDraftMarketingAuthorisationApplication (payload) {
    let url = `${TEST_SUPPORT_API_URL}/MarketingAuthorisationApplication/saveAsDraft`
...
async function createRenewalMarketingAuthorisationApplication (payload) {
    let url = `${TEST_SUPPORT_API_URL}/MarketingAuthorisationApplication/renewal`
...
async function createVariationMarketingAuthorisationApplication (payload) {
    let url = `${TEST_SUPPORT_API_URL}/MarketingAuthorisationApplication/CreateBasicVariation`
...
async function deleteMarketingAuthorisationApplication (maApplicationId) {
    let url = `${TEST_SUPPORT_API_URL}/MarketingAuthorisationApplication/${maApplicationId}`
...
async function deleteMarketingAuthorisationApplicationByInternalReference (maInternalReference) {
    let url = `${TEST_SUPPORT_API_URL}/MarketingAuthorisationApplication/deleteByInternalReference/${maInternalReference}`
